...
function App() {
    return (
      <div className="Container">
        <div id="carouselExampleControls" class="carousel slide multi-item-carousel" data-ride="carousel">     
          ...
          <div class="carousel-item active" >
            <div className="Container-inside">
              <h1 className="Song-Title">Hamari Saanson</h1>
          ...
          <div class="carousel-item">
            <div className="Container-inside">
            <h1 className="Song-Title">Kala Chasma</h1>    
            <h6>Artist: Arijit Singh</h6>
            <h6>Album: Baar Baar Dekho</h6>
            <h6>Released: 2016</h6> 
          <div>
          ...
          <div class="carousel-item">
            <div className="Container-inside">
              <h1 className="Song-Title">Mann Bharya</h1>
              <h6>Artist: Arijit Singh</h6>
              <h6>Album: Baar Baar Dekho</h6>
              <h6>Released: 2016</h6> 
              <div>
        ...
        <div class="carousel-item">
          <div className="Container-inside">
            <h1 className="Song-Title">Ashiqui Aa Gayi</h1>
            <h6>Artist: Arijit Singh</h6>
            <h6>Album: Baar Baar Dekho</h6> 
            <h6>Released: 2016</h6>
            <div>
        ...
        <div class="carousel-item">
          <div className="Container-inside">
            <h1 className="Song-Title">Baaris</h1>
            <h6>Artist: Arijit Singh</h6>
            <h6>Album: Baar Baar Dekho</h6> 
            <h6>Released: 2016</h6>
            <div>
        ...
        <div class="carousel-item">
          <div className="Container-inside">
            <h1 className="Song-Title">Baris Ki Jaaye</h1>
            <h6>Artist: Arijit Singh</h6>
            <h6>Album: Baar Baar Dekho</h6> 
            <h6>Released: 2016</h6>
            <div>
        ...
        <div class="carousel-item">
          <div className="Container-inside">
            <h1 className="Song-Title">Bachpan Ka Pyar</h1>
            <h6>Artist: Arijit Singh</h6>
            <h6>Album: Baar Baar Dekho</h6> 
            <h6>Released: 2016</h6>
            <div>
        ...
        <div class="carousel-item">
          <div className="Container-inside">
            <h1 className="Song-Title">Galliyan</h1>
            <h6>Artist: Arijit Singh</h6>
            <h6>Album: Baar Baar Dekho</h6> 
            <h6>Released: 2016</h6>
            <div>
